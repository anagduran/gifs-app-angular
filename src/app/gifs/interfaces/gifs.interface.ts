// To parse this data:
//
//   import { Convert, SearchGfisResponse } from "./file";
//
//   const searchGfisResponse = Convert.toSearchGfisResponse(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SearchGfisResponse {
    data:       Gif[];
...
export class Convert {
    public static toSearchGfisResponse(json: string): SearchGfisResponse {
        return cast(JSON.parse(json), r("SearchGfisResponse"));
    }

    public static searchGfisResponseToJson(value: SearchGfisResponse): string {
        return JSON.stringify(uncast(value, r("SearchGfisResponse")), null, 2);
    }
}
